    ...
    function showUpgradeModal(isBonusRound = false) {
      ...
      // WEAPON UNLOCK: Level 4, 8, 15, 20 — show ONLY 6 weapon choices (no stat upgrades)
        ...
        const newWeaponChoices = [
          ...
          { id: 'doublebarrel',icon: '🔫',  title: 'DOUBLE BARREL',  desc: 'Devastating 12-pellet shotgun swarm',      active: () => weapons.doubleBarrel.active,apply: () => { weapons.doubleBarrel.active = true; weapons.doubleBarrel.level = 1; showStatChange('New Weapon: Double Barrel'); questCheck(); } },
