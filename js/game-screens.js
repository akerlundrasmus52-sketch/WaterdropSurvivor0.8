...
// Depends on: all previously loaded game files
    ...
    function playRoundStartCinematic(callback) {
      ...
      // Region label data (ultra-compact positions - 80x80 map, all landmarks at edges)
      const regions = [
    ...
    function showProgressionShop() {
      ...
      // ── Stat Upgrades only (Harvesting Tools are in the Forge building) ────
    ...
    function _showProgressionShopOverlay() {
      ...
      const _rebuild = () => {
        ...
        // ── Stat Upgrades only (Harvesting Tools belong in the Forge) ────────
